 ...
 */
export function calculateFee(size: number, price: number): number {
 ...
 */
export function calculateTotalCost(size: number, price: number): number {
 ...
 */
export function calculateSellProceeds(size: number, price: number): number {
